...
public class Teacher {
    ...
    private Properties db;//暂时还没有用到

    public Teacher(Properties db) {
        this.db = db;
    }
    ...
    public Teacher(String name, int age, List<String> friendName, Set<String> loverName, Map<String, Double> score) {
        this.name = name;
        this.age = age;
